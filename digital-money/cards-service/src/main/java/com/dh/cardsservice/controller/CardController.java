...
public class CardController {
    ...
    public ResponseEntity<List<Card>> searchCardsByAccountId (@PathVariable Long id ) throws ResourceNotFoundException {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Card> findCardById(@PathVariable Long id) throws ResourceNotFoundException {
...
//    }
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Object> updateCardBalance(@PathVariable Long id, @RequestBody Card card) {
        try {
            cardService.updateCardBalanceById(id, card);
