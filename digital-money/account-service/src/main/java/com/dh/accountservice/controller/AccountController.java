...
public class AccountController {
    ...
    public ResponseEntity<AccountTransactionsDTO>  findTransactionsByAccountId(@PathVariable Long id ) throws ResourceNotFoundException {
    ...
    public ResponseEntity<AccountTransactionDTO>  findTransactionByAccountId(@PathVariable Long accountId,
                                                                             @PathVariable Long transactionId)
            throws ResourceNotFoundException {
        try {
            AccountTransactionDTO transactionDTO = accountService.findAccountWithTransactionById(accountId, transactionId);
    ...
    @GetMapping("/{id}/cards")
    public ResponseEntity<AccountCardsDTO>  findAllCardsByAccountId(@PathVariable Long id ) throws ResourceNotFoundException {
    ...
    public ResponseEntity<AccountsCardDTO>  findAccountWithCard(@PathVariable Long accountId, @PathVariable Long cardId) throws ResourceNotFoundException {
            return ResponseEntity.ok(accountService.findAccountWithCardById(accountId, cardId));

    }

    @DeleteMapping("/{accountId}/cards/{cardId}")
    public ResponseEntity<String> deleteCardById(@PathVariable Long accountId, @PathVariable Long cardId) {
        try {
            accountService.deleteCardById(accountId, cardId);
            return ResponseEntity.ok("We delete the card with id : " + cardId);
        } catch (ResourceNotFoundException e) {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<AccountDTO> findAccountById (@PathVariable Long id) throws ResourceNotFoundException {
    ...
    @GetMapping("/user/{id}")
    public ResponseEntity<AccountDTO> findAccountByUserId (@PathVariable Long id) throws ResourceNotFoundException {
   ...
   @PostMapping("/{id}/transferences/cvu")
   ...
   @PatchMapping("/{id}")
    ...
    public ResponseEntity<Object> registerTransference(@PathVariable Long id, @RequestBody TransferenceRequestDTO request) {
        try {
            accountService.registerTransference(id, request);
